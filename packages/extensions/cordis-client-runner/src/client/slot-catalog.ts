...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-models GeoCrmHeroMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.hero.wordmark',
    kind: 'single',
    scope: 'root',
    summary: 'Product name shown in place of the blank-session headline and preview badge.',
    doc: 'Product name shown in place of the blank-session headline and preview badge.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-models GeoCrmHeroWordmark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-models GeoCrmGate',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models GeoCrmBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models GeoCrmBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
