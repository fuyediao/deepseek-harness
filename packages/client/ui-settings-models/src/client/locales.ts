...
export const en = {
  ...
  desktopIntro: 'Models come from your GeoCRM catalog (ChatGPT, Gemini, Claude, Grok, DeepSeek, and the rest of the allowlist). Vendor API keys stay in GeoCRM Settings.',
  edit: 'Edit',
  ...
  modelsSessionHint: 'This window is already signed in. Sign out returns to the sign-in panel. Vendor API keys stay in GeoCRM Settings.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  desktopIntro: '模型来自你的 GeoCRM 目录（ChatGPT、Gemini、Claude、Grok、DeepSeek 及允许名单中的其余模型）。供应商 API 密钥仍在 GeoCRM 设置中管理。',
  edit: '编辑',
  ...
  modelsSessionHint: '本窗口已登录。退出登录会回到登录页。供应商 API 密钥仍保存在 GeoCRM 设置中。',
  gateTitle: '欢迎回来',
  gateChecking: '正在检查会话\u2026',
  brandName: 'GeoCRM Harness',
