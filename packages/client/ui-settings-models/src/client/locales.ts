...
export const en = {
  ...
  desktopIntro: 'Models come from your GeoCRM catalog. Vendors without a key show Not Configured. Enable the models you want in the menu; keys stay in GeoCRM Settings.',
  edit: 'Edit',
  ...
  modelsSessionHint: 'This window is already signed in. Sign out returns to the sign-in panel. Vendor API keys stay in GeoCRM Settings. This catalog lists every GeoCRM model; vendors without a key show Not Configured. The model menu lists only enabled models that have a key.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  desktopIntro: '模型来自你的 GeoCRM 目录。没有密钥的供应商显示未设定。开启你要出现在菜单里的模型；密钥仍保存在 GeoCRM 设置中。',
  edit: '编辑',
  ...
  modelsSessionHint: '本窗口已登录。退出登录会回到登录页。供应商 API 密钥仍保存在 GeoCRM 设置中。此目录列出全部 GeoCRM 模型；没有密钥的供应商显示未设定。模型菜单只列出已开启且已有密钥的模型。',
  gateTitle: '欢迎回来',
  gateChecking: '正在检查会话\u2026',
  brandName: 'GeoCRM Harness',
