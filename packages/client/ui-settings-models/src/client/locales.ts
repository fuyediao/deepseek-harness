...
export const en = {
  ...
  desktopIntro: 'Models come from your GeoCRM catalog. Only vendors with a key in GeoCRM Settings appear (including DeepSeek). Add keys there; they are not stored here.',
  edit: 'Edit',
  ...
  modelsSessionHint: 'This window is already signed in. Sign out returns to the sign-in panel. Vendor API keys stay in GeoCRM Settings. Only vendors with a key appear in this catalog and in the model menu.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  desktopIntro: '模型来自你的 GeoCRM 目录。只有在 GeoCRM 设置中已保存密钥的供应商会出现（包括 DeepSeek）。请在那边添加密钥；这里不保存。',
  edit: '编辑',
  ...
  modelsSessionHint: '本窗口已登录。退出登录会回到登录页。供应商 API 密钥仍保存在 GeoCRM 设置中。此目录和模型菜单只列出已有密钥的供应商。',
  gateTitle: '欢迎回来',
  gateChecking: '正在检查会话\u2026',
  brandName: 'GeoCRM Harness',
