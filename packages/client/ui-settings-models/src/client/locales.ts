...
export const en = {
  ...
  signInHint: 'Sign in with your GeoCRM employee ID or email. Vendor API keys stay in GeoCRM Settings.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  signInHint: '使用 GeoCRM 工号或邮箱登录。供应商 API 密钥仍保存在 GeoCRM 设置中。',
  loginMode: '登录方式',
