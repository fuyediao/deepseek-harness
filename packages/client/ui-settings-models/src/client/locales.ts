...
export const en = {
  ...
  desktopIntro: 'Models come from your GeoCRM catalog. Vendors without a key show Not Configured and cannot be enabled. Enable keyed models you want in the menu; keys stay in GeoCRM Settings.',
  edit: 'Edit',
  ...
  signInHint: 'Sign in with Google, or with your GeoCRM employee ID or email. The session stays signed in; vendor API keys stay in GeoCRM Settings.',
  modelsSessionHint: 'This window is already signed in. Sign out returns to the sign-in panel. Vendor API keys stay in GeoCRM Settings. This catalog lists every GeoCRM model; vendors without a key show Not Configured and cannot be enabled. The model menu lists only enabled models that have a key.',
  gateTitle: 'Welcome back',
  gateChecking: 'Checking your session\u2026',
  brandName: 'GeoCRM Harness',
  signInWithGoogle: 'Continue with Google',
  signingInWithGoogle: 'Opening Google\u2026',
  signInDivider: 'or',
  googleSignInCancelled: 'Google sign-in was cancelled.',
  googleSignInInProgress: 'Google sign-in is already open in your browser.',
  googleSignInUnavailable: 'Google sign-in is only available in the desktop app.',
  googleSignInFailed: 'Google sign-in failed.',
  loginMode: 'Sign-in method',
  loginModeEmployeeId: 'Employee ID',
  loginModeEmail: 'Email',
  employeeId: 'Employee ID',
  employeeIdPlaceholder: 'PS0001',
  employeeIdRequired: 'Enter your employee ID.',
  employeeIdInvalid: 'Employee ID must look like PS0001.',
  loginEmail: 'Email',
  ...
  accountRole: 'Role:',
  accountDesktopAgent: 'Harness access is enabled (desktop_agent).',
  accountNoDesktopAgent: 'This account does not have desktop_agent. GeoCRM Harness tools and the model gateway will refuse requests.',
  loginFailed: 'Sign-in failed.',
  accessCheckFailed: 'Signed in, but the access check failed.',
  ...
  modelsKeyed: 'Only vendors with a saved API key',
  catalogLive: 'GeoCRM catalog',
  catalogLoading: 'Loading models\u2026',
  catalogSearch: 'Search models\u2026',
  catalogRefresh: 'Refresh models',
  catalogRefreshing: 'Refreshing\u2026',
  catalogEmpty: 'No models in the GeoCRM catalog.',
  catalogNoMatches: 'No matching models.',
  catalogToggle: 'Show {model} in the model menu',
  ...
  desktopWelcomeTitle: 'Welcome to GeoCRM Harness',
  desktopWelcomeBody: 'GeoCRM Harness desktop is the signed-in workspace for CRM work. Sign in with Google, or with your employee ID or email. Vendor API keys stay in GeoCRM Settings.\n\nThis window talks to your GeoCRM deployment. Use Settings → Models to sign out.',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  desktopIntro: '模型来自你的 GeoCRM 目录。没有密钥的供应商显示未设定，且不能开启。开启你要出现在菜单里的已配置模型；密钥仍保存在 GeoCRM 设置中。',
  edit: '编辑',
  ...
  signInHint: '使用 Google 登录，或使用 GeoCRM 工号或邮箱。登录后会话会保持；供应商 API 密钥仍保存在 GeoCRM 设置中。',
  modelsSessionHint: '本窗口已登录。退出登录会回到登录页。供应商 API 密钥仍保存在 GeoCRM 设置中。此目录列出全部 GeoCRM 模型；没有密钥的供应商显示未设定，且不能开启。模型菜单只列出已开启且已有密钥的模型。',
  gateTitle: '欢迎回来',
  gateChecking: '正在检查会话\u2026',
  brandName: 'GeoCRM Harness',
  signInWithGoogle: '使用 Google 登录',
  signingInWithGoogle: '正在打开 Google\u2026',
  signInDivider: '或',
  googleSignInCancelled: '已取消 Google 登录。',
  googleSignInInProgress: '浏览器中已有正在进行的 Google 登录。',
  googleSignInUnavailable: 'Google 登录仅在桌面端可用。',
  ...
  employeeIdInvalid: '工号格式应为 PS0001。',
  loginEmail: '邮箱',
  loginEmailPlaceholder: 'you@example.com',
  emailRequired: '请输入邮箱。',
  loginPassword: '密码',
  ...
  accountSignedIn: '已登录',
  accountRole: '角色：',
  accountDesktopAgent: '已开通 Harness 权限（desktop_agent）。',
  accountNoDesktopAgent: '此账号没有 desktop_agent。GeoCRM Harness 工具与模型网关会拒绝请求。',
  loginFailed: '登录失败。',
  accessCheckFailed: '已登录，但权限检查失败。',
  ...
  modelsKeyed: '仅列出已保存 API 密钥的供应商',
  catalogLive: 'GeoCRM 目录',
  catalogLoading: '正在加载模型\u2026',
  catalogSearch: '搜索模型\u2026',
  catalogRefresh: '刷新模型',
  catalogRefreshing: '正在刷新\u2026',
  catalogEmpty: 'GeoCRM 目录中没有模型。',
  catalogNoMatches: '没有匹配的模型。',
  catalogToggle: '在模型菜单中显示 {model}',
  notConfigured: '未设定',
  ...
  desktopWelcomeTitle: '欢迎使用 GeoCRM Harness',
  desktopWelcomeBody: 'GeoCRM Harness 桌面端是登录后使用的 CRM 工作区。请使用 Google 登录，或使用工号或邮箱。供应商 API 密钥仍保存在 GeoCRM 设置中。\n\n本窗口连接到你的 GeoCRM 部署。可在「设置 → 模型」中退出登录。',
}
