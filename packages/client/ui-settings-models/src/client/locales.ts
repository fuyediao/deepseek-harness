...
export const en = {
  ...
  modelsSessionHint: 'This window is already signed in. Sign out returns to the sign-in panel. Vendor API keys stay in GeoCRM Settings. Only vendors with a key appear in the model menu.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelsSessionHint: '本窗口已登录。退出登录会回到登录页。供应商 API 密钥仍保存在 GeoCRM 设置中。模型菜单只列出已有密钥的供应商。',
  gateTitle: '欢迎回来',
  gateChecking: '正在检查会话\u2026',
  brandName: 'GeoCRM Harness',
